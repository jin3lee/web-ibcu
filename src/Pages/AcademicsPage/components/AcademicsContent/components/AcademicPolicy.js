...
class AcademicPolicy extends React.Component {
      ...
      <div style={ style.container }>
        ...
        <div style={{ flex: 3,  marginLeft: '10%', marginRight: '3%', marginTop: 30 }}>
          <div style={{ display: 'flex', flexDirection: 'row', color: 'rgb(90, 90, 90)' }}>
            ...
            <button style={ style.currentBackFlowButtonStyle }>
              GPA Information
            </button>
          </div>
...
export default connect( mapStateToProps )( AcademicPolicy );
